...
static  CPU_INT32U  NetDev_ClkFreqGet         (NET_IF                          *p_if,
        ...
        void        NetDev_ISR_Handler        (CPU_INT32U                       cpu);
...
#define  CV_REG_SYSMGR_EMACGRP (*((CPU_REG32 *)0xFFD08060))
#define  CV_REG_RSTMGR_PERMOD (*((CPU_REG32 *)0xFFD05014))
                             ...
                             NET_ERR  *p_err)
{
   ...
   CV_REG_RSTMGR_PERMOD |= DEF_BIT_01;                          /* Reset EMAC1                                          */
   CPU_MB();

   CV_REG_SYSMGR_EMACGRP = 0x00;
   CV_REG_SYSMGR_EMACGRP = 0x00000005;                          /* Select RGMII interface.                              */

   CPU_MB();
   CV_REG_RSTMGR_PERMOD &= ~DEF_BIT_01;
   CPU_MB();
