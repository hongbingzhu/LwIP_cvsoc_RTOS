...
#define  BMCR_SPEED_MASK             (DEF_BIT_04 | DEF_BIT_05 | DEF_BIT_06)
#define  BMCR_SPEED10_MASK            DEF_BIT_04
#define  BMCR_SPEED100_MASK           DEF_BIT_05
...
#define  SSR_LINK                     DEF_BIT_10                /* Link state mask                                          */
                                                                /* Speed mask                                               */
#define  SSR_SPD_MASK            (DEF_BIT_04 | DEF_BIT_05 | DEF_BIT_06)
#define  SSR_SPD_1000                 DEF_BIT_06                /* Speed 1000 MBit/s mask                                   */
#define  SSR_SPD_100                  DEF_BIT_05                /* Speed 100 MBit/s mask                                    */
#define  SSR_SPD_10                   DEF_BIT_04                /* Speed 1000 MBit/s mask                                   */
#define  SSR_FD                       DEF_BIT_03                /* Full duplex mode mask                                    */
...
const  NET_PHY_API_ETHER  NetPhy_API_ksz9021r = { NetPhy_Init,                      /*   Init                           */
                           ...
                           NET_ERR  *perr)
{
    ...
    pdev_api->Phy_RegWr(pif, phy_addr, 0x0b, 0x8000 | 0x105, perr);
    pdev_api->Phy_RegWr(pif, phy_addr, 0x0c, 0, perr);

    pdev_api->Phy_RegWr(pif, phy_addr, 0x0b, 0x8000 | 0x106, perr);
    pdev_api->Phy_RegWr(pif, phy_addr, 0x0c, 0, perr);

    pdev_api->Phy_RegWr(pif, phy_addr, 0x0b, 0x8000 | 0x104, perr);
    pdev_api->Phy_RegWr(pif, phy_addr, 0x0c, 0xA0D0, perr);
