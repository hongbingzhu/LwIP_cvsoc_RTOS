...
const  NET_DEV_CFG_ETHER  NetDev_Cfg_Ether_1 = {
    ...
    1536u,                          /* Desired size      of device's large receive  buffers (in octets) [see Note #2].  */
      48u,                          /* Desired number    of device's large receive  buffers             [see Note #3a]. */
    ...
    1632u,                          /* Desired size      of device's large transmit buffers (in octets) [see Note #2].  */
      48u,                          /* Desired number    of device's large transmit buffers             [see Note #3b]. */
     160u,                          /* Desired size      of device's small transmit buffers (in octets) [see Note #2].  */
      48u,                          /* Desired number    of device's small transmit buffers             [see Note #3b]. */
     ...
     0xFFFF0000,                    /* Base address   of dedicated memory, if available.                                */
        0x1000u,                    /* Size           of dedicated memory, if available (in octets).                    */
    ...
    NET_DEV_CFG_FLAG_NONE,          /* Desired option flags, if any (see Note #6).                                      */
     ...
     0xFF702000,                    /* Base address   of device's hardware/registers.                                   */

             0u,                    /* Size           of device's data bus (in bits), if available.                     */


   "00:AB:CD:EF:80:AA",             /* Desired device hardware address; may be NULL address or string ...               */
