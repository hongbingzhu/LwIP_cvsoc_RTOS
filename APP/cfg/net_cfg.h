...
#define  NET_CFG_IF_RX_Q_SIZE                  500u             /*Configure RX queue size (See Note #1).                */
#define  NET_CFG_IF_TX_DEALLOC_Q_SIZE          500u             /*Configure TX queue size (See Note #2).                */
...
#define  NET_IF_CFG_TX_SUSPEND_TIMEOUT_MS       0u              /* Configure interface transmit suspend timeout in ms.  */
...
#define  NET_SOCK_CFG_CONN_ACCEPT_Q_SIZE_MAX    2u              /* maximum size. (See Note # 1)                         */
                                                                ...
                                                                /* (see Note #2):                                       */
#define  NET_SOCK_CFG_RX_Q_SIZE_OCTET           1024u*8u        /* Configure socket receive  queue buffer size.         */
#define  NET_SOCK_CFG_TX_Q_SIZE_OCTET           1024u*8u        /* Configure socket transmit queue buffer size.         */
...
/*                                                                                                                      */
/*                                                  Configure calculation in transmission.                              */
#define  NET_ICMP_CFG_CHK_SUM_OFFLOAD_TX_EN  DEF_ENABLED
/*                                                                                                                      */
/*                                                                                                                      */
/* --------------------------------------------------- UDP CHECKSUM --------------------------------------------------- */
/*                                                  Configure validation in reception.                                  */
...
/* --------------------------------------------------- TCP CHECKSUM --------------------------------------------------- */
/*                                                  Configure validation in reception.                                  */
#define  NET_TCP_CFG_CHK_SUM_OFFLOAD_RX      DEF_ENABLED
/*                                                                                                                      */
/*                                                  Configure calculation in transmission.                              */
#define  NET_TCP_CFG_CHK_SUM_OFFLOAD_TX      DEF_ENABLED
/* ==================================================================================================================== */
