...
*
* Arguments  : p_sem         is a pointer to the monitor to delete
*
...
*                                OS_ERR_OBJ_TYPE                If 'p_sem' is not pointing at a monitor
...
*
* Description: This function is called by OSMonDel() to clear the contents of a semaphore
*
